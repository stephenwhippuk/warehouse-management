-- Deploy inventory-service:001_initial_schema to pg
-- requires: 
...
-- Comments
COMMENT ON TABLE inventory IS 'Inventory stock levels and tracking - managed by inventory-service';
COMMENT ON TABLE inventory_movements IS 'Audit trail of inventory changes - managed by inventory-service';
