/**
 * @file validate_contracts.cpp
 * @brief Command-line tool for validating service contracts
 * 
 * Usage: ./validate-contracts [options]
 * 
 * Options:
 *   --contracts-root <path>    Path to global contracts directory (default: /home/stephen/localdev/experiments/warehouse-management/contracts)
...
void printUsage(const char* progName) {
    ...
    std::cout << "Options:\n";
    std::cout << "  --contracts-root <path>    Path to global contracts directory\n";
    std::cout << "                             (default: /home/stephen/localdev/experiments/warehouse-management/contracts)\n";
...
int main(int argc, char* argv[]) {
    ...
    if (args.verbose) {
        inventory::utils::Logger::info("Contract Validator");
        inventory::utils::Logger::info("Contracts root: {}", args.contractsRoot);
        inventory::utils::Logger::info("Service contracts: {}", args.serviceContracts);
        inventory::utils::Logger::info("Claims file: {}", args.claims);
    }
